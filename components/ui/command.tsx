...
>(({ className, ...props }, ref) => (
  <CommandPrimitive
    ref={ref}
    className={cn(
      'flex h-full w-full flex-col overflow-hidden rounded-sm bg-neutral-600 text-neutral-950 dark:bg-neutral-950 dark:text-neutral-50',
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <div className='flex items-center border-b px-3' cmdk-input-wrapper=''>
    ...
    <CommandPrimitive.Input
      ref={ref}
      className={cn(
        'flex h-11 w-full rounded-sm bg-neutral-600 py-3 text-sm outline-none placeholder:text-neutral-200 disabled:cursor-not-allowed disabled:opacity-50 dark:placeholder:text-neutral-400',
        className
      )}
      {...props}
    />
